...
// Boolean-kind metrics (app/stats.py's PLAYER_METRICS registry) — their
// hit-rate threshold number is ignored server-side, so don't echo a stale
// one in the label.
const BOOL_METRICS = new Set(['carded'])
